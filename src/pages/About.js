...
import backgroundImage from "../assets/backgrounds/img.png";
import missionLogo from "../assets/about/mission-logo.png";
import visionLogo from "../assets/about/vision-logo.png";
...
const About = () => {
    return (
        <div className="bg-white text-black min-h-screen">
            ...
            <header className="py-10 bg-cover bg-center" style={{ backgroundImage: `url(${backgroundImage})` }}>
                <div className="container mx-auto px-6 text-center md:text-left md:flex items-center justify-between">
                    <div className="mb-6 md:mb-0 md:w-1/2">
                        ...
                        <p className="font-bold leading-relaxed mb-8 text-black-900">
            ...
            <section className="py-16 bg-gradient-to-r from-white-500 via-white-600 to-white-700">
                <div className="container mx-auto px-6 text-center">
                    <div className="flex justify-center space-x-8">
                        {/* Mission Section */}
                        <div className="bg-gradient-to-r from-white-600 to-blue-700 text-black p-8 rounded-xl shadow-2xl max-w-lg hover:translate-y-4">
                            <h2 className="text-3xl font-bold mb-4 text-yellow-400">
                                <i className="fas fa-bullseye text-yellow-400 mr-2"></i> Our Mission
                            </h2>
                            {/* Mission Image */}
                            <img
                                src={missionLogo} // Replace with your logo URL
                                alt="Mission Logo"
                        ...
                        <div className="bg-gradient-to-r from-white-600 via-blue-700 to-blue-800 text-black p-8 rounded-xl shadow-2xl max-w-lg hover:translate-y-4">
                            <h2 className="text-3xl font-bold mb-4 text-yellow-400">
                                <i className="fas fa-lightbulb text-yellow-400 mr-2"></i> Our Vision
                            </h2>
                            {/* Vision Image */}
                            <img
                                src={visionLogo} // Replace with your logo URL
                                alt="Vision Logo"
                                className="w-20 h-20 mx-auto mb-4 rounded-full"
                            />
            ...
            <section className="py-16 bg-black-700">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6">
                        {/* Testimonial Card 1 */}
                        <div className="bg-blue-400 text-black p-8 rounded-lg shadow-lg max-w-xs transform transition-transform duration-300 hover:bg-blue-600 active:bg-lightBlue-400 hover:translate-y-4">
