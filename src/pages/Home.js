        ...
        <div className="bg-blue-950 text-white min-h-screen">
            ...
            <section className="py-16">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-3xl font-bold mb-8">Why Choose BODOAPP?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-blue-700 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold mb-4">Easy to Use</h3>
                            <p className="text-sm leading-relaxed">
                                Our platform is designed to make finding boarding places simple and straightforward for everyone.
                            </p>
                        </div>
                        <div className="bg-blue-700 p-6 rounded-lg shadow-lg">
